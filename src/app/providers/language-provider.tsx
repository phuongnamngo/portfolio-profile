...
const translations = {
    en: {
        ...
        'exp.job1.achievement': 'Helped deliver projects on schedule (Bitgert Exchange, Zogux Exchange, and others), contributing to team project bonuses / outstanding-performance awards for meeting committed delivery timelines.',
        ...
        'projects.fliam.desc': 'Freelance marketplace (gigs, orders, profiles).',
        'projects.fliam.h1': 'Laravel, PHP, MySQL — Figma page updates; backend/frontend features per lead requests.',
    ...
    vi: {
        ...
        'exp.job1.achievement': 'Đóng góp hoàn thành dự án đúng thời hạn (Bitgert Exchange, Zogux Exchange và một số dự án khác), giúp nhóm nhận thưởng dự án / thưởng thành tích xuất sắc vì đáp ứng tiến độ giao hàng đã cam kết.',
        ...
        'projects.fliam.title': 'Fliam',
        'projects.fliam.desc': 'Sàn kết nối freelancer và khách hàng (gig, đơn hàng, hồ sơ).',
        'projects.fliam.h1': 'Laravel, PHP, MySQL — chỉnh trang theo Figma, phát triển tính năng BE/FE theo yêu cầu leader.',
